...
/// a `KrillEngine.InferenceEngine`-backed generator on top of this.
...
/// family-aware `KrillServer.ToolCalling.extractToolCalls` once the
...
///
/// Sub-PR A's KrillAgent module is self-contained - we keep a tight
/// re-implementation here so the loop can be unit-tested without
/// pulling in the `KrillServer` target. Sub-PR B replaces this with
