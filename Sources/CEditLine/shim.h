#ifndef KRILL_CEDITLINE_SHIM_H
#define KRILL_CEDITLINE_SHIM_H
...
static inline void krill_set_attempted_completion(CPPFunction *fn) {
    rl_attempted_completion_function = fn;
}
static inline void krill_set_completion_over(int value) {
