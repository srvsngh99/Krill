...
| [0004](0004-interactive-questions-and-adaptive-mode.md) | Interactive questions, plan promotion, and the adaptive posture (one `UserQuestionGate` seam, two read-only tools; guarded `PermissionBox.promote`; `"auto"` unchanged) | adopted | 2026-08-23 |
