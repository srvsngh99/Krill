...
final class Gemma4SmokeTests: XCTestCase {
    ...
    private func assetsDir() -> URL {
        if let override = ProcessInfo.processInfo.environment["KRILL_BENCH_ASSETS_DIR"], !override.isEmpty {
    ...
    /// Skips unless KRILL_GEMMA4_MODEL_PATH + the speech fixture are present.
