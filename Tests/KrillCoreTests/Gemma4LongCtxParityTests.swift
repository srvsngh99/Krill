...
final class Gemma4LongCtxParityTests: XCTestCase {
    ...
    func testLongCtxParity() throws {
        guard let dirPath = ProcessInfo.processInfo.environment["KRILL_GEMMA4_PARITY_DIR"] else {
            throw XCTSkip("Set KRILL_GEMMA4_PARITY_DIR (see tools/verify_gemma4_longctx_parity.py)")
        }
