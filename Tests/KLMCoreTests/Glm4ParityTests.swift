...
///
/// Gated on `KLM_GLM4_PARITY_DIR`, a directory produced by
...
final class Glm4ParityTests: XCTestCase {
    ...
    func testNativeGlm4MatchesMLXLMLogits() throws {
        guard let dirPath = ProcessInfo.processInfo.environment["KLM_GLM4_PARITY_DIR"] else {
            throw XCTSkip("Set KLM_GLM4_PARITY_DIR (see tools/verify_glm4_parity.py)")
        }
