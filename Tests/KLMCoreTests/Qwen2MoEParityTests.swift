...
///
/// Gated on `KLM_QWEN2_MOE_PARITY_DIR`, a directory produced by
...
final class Qwen2MoEParityTests: XCTestCase {
    ...
    func testNativeQwen2MoEMatchesMLXLMLogits() throws {
        guard let dirPath = ProcessInfo.processInfo.environment["KLM_QWEN2_MOE_PARITY_DIR"] else {
            throw XCTSkip("Set KLM_QWEN2_MOE_PARITY_DIR (see tools/verify_qwen2_moe_parity.py)")
        }
